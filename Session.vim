...
set shortmess=aoO
badd +1 Makefile
badd +26 old_Makefile
badd +108 breakout.cpp
badd +66 main.cpp
badd +6 breakout.h
badd +7 shell.h
badd +0 shell.cpp
...
badd +1 znode.cpp
badd +0 znode.h
badd +1 zscene_node.cpp
badd +0 zscene_node.h
badd +1 zsprite_node.cpp
badd +0 zsprite_node.h
badd +0 main.js
badd +5 sprite_renderer.cpp
badd +0 sprite_renderer.h
badd +1 shader.cpp
badd +0 shader.h
badd +1 resource_manager.cpp
badd +0 resource_manager.h
badd +3 shaders/sprite.vs
badd +0 shaders/sprite.fs
badd +1 texture.cpp
badd +0 texture.h
badd +22 events.h
argglobal
...
silent! normal! zE
let s:l = 123 - ((37 * winheight(0) + 30) / 61)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 41 - ((34 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
wincmd w
argglobal
edit ~/graphics/shaders/sprite.fs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((14 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 152 - ((32 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 38 - ((37 * winheight(0) + 30) / 61)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
...
exe 'vert 1resize ' . ((&columns * 93 + 93) / 187)
exe 'vert 2resize ' . ((&columns * 93 + 93) / 187)
tabedit ~/graphics/zscene_node.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 93 + 93) / 187)
exe 'vert 2resize ' . ((&columns * 93 + 93) / 187)
tabedit ~/graphics/zsprite_node.h
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/graphics/zsprite_node.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
