...
nmap  p :Preview 
nmap  r :redraw!
nmap  z :silent !cd ~/graphics/zengine3d/ && ./zengine.bin
nmap  mcz :silent !cd ~/graphics/zengine3d && make clean
nmap  mz :silent !cd ~/graphics/zengine3d && make
nmap  gw :Gwrite
nmap  gp :Gpush
nmap  gl :Glog
nmap  gb :Gblame
...
badd +1 zengine.cpp
badd +1 ~/.vimrc
badd +0 ~/.vim/bundle/vim-snipmate/doc/SnipMate.txt
argglobal
silent! argdel *
argadd zengine.cpp
set stal=2
...
silent! normal! zE
let s:l = 22 - ((19 * winheight(0) + 29) / 58)
...
1
normal! 016|
tabedit ~/.vim/bundle/vim-snipmate/doc/SnipMate.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
