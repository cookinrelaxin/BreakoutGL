...
int main() {
    ...
    GLuint diffuseMap = loadTexture("../../assets/textures/brickwall.png");
    GLuint normalMap = loadTexture("../../assets/textures/brickwall_normal.png");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::vec3 lightPos(sinf(currentFrame), cosf(currentFrame), 0.3f);
        ...
        glUniform1i(glGetUniformLocation(shader.Program, "normalMapping"), enableNormalMapping);

        glm::mat4 model;
        //model = glm::rotate(model, 0.01f * sinf(currentFrame) * cosf(currentFrame), glm::normalize(glm::vec3(1.0, 0.0, 1.0)));
...
void Do_Movement() {
    ...
    if (keys[GLFW_KEY_N] && !keysPressed[GLFW_KEY_N]) {
        ...
        std::cout << "toggle normal mapping" << std::endl;
    }
}
