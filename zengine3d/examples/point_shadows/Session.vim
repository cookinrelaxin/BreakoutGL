...
noremap <F5> :let _s=@/|:%s/\s\+$//e|:let @/=_s|
...
silent only
cd ~/graphics/zengine3d/examples/shadows
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/graphics/zengine3d/examples/shadows/shadows.cpp
badd +1 ~/graphics/zengine3d/examples/shadows/shadow_mapping.fs
badd +0 ~/.vimrc
badd +1 ~/graphics/zengine3d/examples/shadows/shadow_mapping.vs
badd +0 ~/graphics/zengine3d/examples/shadows/shadow_mapping_depth.vs
badd +0 ~/graphics/zengine3d/examples/shadows/shadow_mapping_depth.fs
argglobal
silent! argdel *
argadd shadows.cpp
set stal=2
edit ~/graphics/zengine3d/examples/shadows/shadows.cpp
...
2
normal! 0
tabedit ~/graphics/zengine3d/examples/shadows/shadow_mapping.vs
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/graphics/zengine3d/examples/shadows/shadow_mapping_depth.vs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
edit ~/graphics/zengine3d/examples/shadows/shadow_mapping.fs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 67 - ((33 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
wincmd w
argglobal
edit ~/graphics/zengine3d/examples/shadows/shadow_mapping_depth.fs
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((39 * winheight(0) + 36) / 72)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
