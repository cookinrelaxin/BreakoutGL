...
int main(int argc, const char *argv[]) {
    ...
    //rt_camera cam(90.0f, (float)screenWidth/(float)screenHeight);
    rt_camera cam(glm::vec3(-2.0f, 2.0f, 1.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f), 30.0f, (float)screenWidth/(float)screenHeight);
