#objects = *.cpp
#
#headers = -I/usr/local/include -I./includes -I/usr/local/Cellar/freetype/2.6.3/include/freetype2 -I/usr/local/Cellar/v8/5.0.71.33/ -I/usr/local/Cellar/nlohmann_json/1.1.0/include/
#
...
#
#zengine : $(objects)
#	clang++ -o zengine $(objects) $(headers) $(compiler_flags) $(linker_flags)
